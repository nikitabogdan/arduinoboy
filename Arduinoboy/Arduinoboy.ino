...
byte defaultMemoryMap[MEM_MAX] = {
  ...
  4, 7, 5, 3,              //midiOutNoteMessageChannels - midi channels for lsdj midi out note messages Default: channels 1,2,3,4
  4, 7, 5, 3,              //midiOutCCMessageChannels - midi channels for lsdj midi out CC messages Default: channels 1,2,3,4
  ...
  20,1,  //midiout bit check delay & bit check delay multiplier
